...
print("\tint(), float(), str(), bool() -> caster, convertir une donnée, varaible...")
...
print("\tPour déclarer une chaîne de caractères (str)\n\t-> nom_de_la_variable = ''chaîne_de_charactère'' (ex: prenom = ''jacky'') !!!ATTENTION UTILISER DES GUIELLEMETS AVEC LES CHAINES DE CHARACTERE!!!")
